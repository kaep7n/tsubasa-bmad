...
- [ ] **Task 1: Create GitHub Repository** (AC: 1)
  - [ ] Go to https://github.com/new and create new repository named "tsubasa"
  - [ ] Choose visibility (private or public) based on preference
  - [ ] Do NOT initialize with README, .gitignore, or license (already exists from Story 1.1)
  - [ ] Copy the remote URL
  - [ ] Add remote to local repo: `git remote add origin <repository-url>`
  - [ ] Push existing code: `git push -u origin main`

- [ ] **Task 2: Create GitHub Actions Workflow File** (AC: 2)
  - [ ] Create directory structure: `.github/workflows/`
  - [ ] Create file `.github/workflows/ci.yml`
  - [ ] Configure workflow triggers (push to main, pull requests)
  - [ ] Add Job 1: Lint with ESLint and Prettier check
  - [ ] Add Job 2: Test with Karma in headless Chrome
  - [ ] Add Job 3: Build Angular production build
  - [ ] Add Job 4: Database tests with pgTAP against Supabase staging
  - [ ] Commit and push workflow file

- [ ] **Task 3: Setup Cloudflare Pages Project** (AC: 3)
  - [ ] Go to https://pages.cloudflare.com/ and login
  - [ ] Click "Create a project"
  - [ ] Connect GitHub account and select "tsubasa" repository
  - [ ] Configure project name: "tsubasa"
  - [ ] Note down the Pages URL assigned

- [ ] **Task 4: Configure Cloudflare Pages Build Settings** (AC: 4)
  - [ ] Set Framework preset: None (custom Angular configuration)
  - [ ] Set Build command: `npm run build`
  - [ ] Set Build output directory: `dist/tsubasa/browser`
...
- [ ] **Task 5: Verify Automatic Deployment** (AC: 5)
  - [ ] Make a small change and commit to `main` branch
  - [ ] Push to GitHub: `git push origin main`
  - [ ] Verify GitHub Actions workflow runs successfully
  - [ ] Verify Cloudflare Pages deployment triggers automatically
  - [ ] Check deployment status in Cloudflare Pages dashboard
  - [ ] Visit deployed URL to confirm app is accessible

- [ ] **Task 6: Enable Preview Deployments** (AC: 6)
  - [ ] In Cloudflare Pages settings, verify preview deployments are enabled
  - [ ] Create a test branch: `git checkout -b test-preview`
  - [ ] Make a small change and push: `git push origin test-preview`
  - [ ] Create pull request on GitHub
  - [ ] Verify preview deployment URL appears in PR comments
  - [ ] Visit preview URL to confirm it works

- [ ] **Task 7: Add Build Status Badge to README** (AC: 7)
  - [ ] Go to GitHub Actions tab in repository
  - [ ] Click on the CI workflow
  - [ ] Click "Create status badge" button
  - [ ] Copy the Markdown badge code
  - [ ] Add badge to top of README.md file
  - [ ] Commit and push README changes
  - [ ] Verify badge appears and shows current build status
